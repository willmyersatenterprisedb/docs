# Release notes for EDB Postgres for Kubernetes 1.21

History of user-visible changes in the 1.21 minor release of EDB Postgres for Kubernetes.

For a complete list of changes, please refer to the
[commits](https://github.com/EnterpriseDB/cloud-native-postgres/commits/release-1.21)
...
!!! Important "Important changes from previous versions"
    ...
    EDB Postgres for Kubernetes with the goal to improve general stability and security through
...
- **OLM installation method**: introduce support for Operator Lifecycle Manager
  ...
  their "EDB Postgres for Kubernetes" operator and adapting it for EDB Postgres for Kubernetes.
